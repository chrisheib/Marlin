...
#define STRING_CONFIG_H_AUTHOR "chrisheib" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "A20M"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 22.42 }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2544 }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1267 }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1662 }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, 0, -0.36 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  225    // (°C) Default nozzle temperature for G26.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT {  -8, 230, 20 }
  #define NOZZLE_PARK_MOVE          0   // Park motion: 0 = XY Move, 1 = X Only, 2 = Y Only, 3 = X before Y, 4 = Y before X
  #define NOZZLE_PARK_Z_RAISE_MIN   2   // (mm) Always raise Z by at least this distance
  #define NOZZLE_PARK_XY_FEEDRATE 600   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE   60   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
